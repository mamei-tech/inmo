...
@section('content')
    ...
    <div class="container-ligh-gray">
        ...
        <div class="light-gray-block float-right">
            ...
            <div class="container-sales">
                <h2 class="color-yellow link-sales"><a href="http://jehidalgorealestate.idxbroker.com/i/brickell-sales">@lang('app.sales')</a></h2>
                <h2 class="color-yellow">/</h2>
                <h2 class="color-yellow link-sales"><a href="http://jehidalgorealestate.idxbroker.com/i/brickell-rentals-">@lang('app.rentals')</a></h2>
            </div>
    ...
    <div class="container-dark-gray">
        ...
        <div class="dark-gray-block">
            ...
            <div class="container-sales">
                <h2 class="color-yellow link-sales"><a href="http://jehidalgorealestate.idxbroker.com/i/downtown-miami-sales">@lang('app.sales')</a></h2>
                <h2 class="color-yellow">/</h2>
                <h2 class="color-yellow link-sales"><a href="http://jehidalgorealestate.idxbroker.com/i/downtown-miami-rentals-">@lang('app.rentals')</a></h2>
            </div>
