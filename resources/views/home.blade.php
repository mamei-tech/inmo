        ...
        <div class="mbr-section__container">
            <div>
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--bg-adapted item dark center mbr-section--full-height active slide-1-edu">
                        <div class="mbr-box__magnet mbr-box__magnet--center-right mbr-box__magnet--sm-padding mbr-after-navbar">
                            <div class="container-text-slider-edu">
                                <div class="position-real-text" >
                                </div>
                                <div class="text-slider-edu">
                                    <div>
                                        <h3 class="titular-1-edu">YOUR NEW HOME</h3>
                    ...
                    <div class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--bg-adapted item dark center mbr-section--full-height slide-2-edu">
                        <div class="mbr-box__magnet mbr-box__magnet--center-right mbr-box__magnet--sm-padding mbr-after-navbar">
                            <div class="container-text-slider-edu">
                                <div class="position-real-text" >
                                </div>
                                <div class="text-slider-edu">
                                    <div>
                                        <h3 class="titular-1-edu">YOU CAN LIVE</h3>
                                        <h3 class="titular-1-edu">IN THE BEST OF MIAMI</h3>
                                        <h3 style="padding-top: 25px;" class="titular-2-edu">PAYING THE BEST PRICES</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--bg-adapted item dark center mbr-section--full-height slide-3-edu">
                        <div class="mbr-box__magnet mbr-box__magnet--center-right mbr-box__magnet--sm-padding mbr-after-navbar">
                            <div class="container-text-slider-edu">
                                <div class="position-real-text" >
                                </div>
                                <div class="text-slider-edu">
                                    <div>
                                        <h3 class="titular-1-edu">ENJOY THE BEST VIEWS</h3>
                                        <h3 class="titular-1-edu">OF A SUMMER</h3>
                                        <h3 style="padding-top: 25px;" class="titular-2-edu">THAT LAST THE ENTIRE YEAR</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
