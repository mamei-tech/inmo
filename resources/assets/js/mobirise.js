(function($){    
    ...
    $(function(){
                ...
                $(this).addClass('mbr-added')
                    .click(function(){
                        $(this)
                            ...
                            .parents('.mbr-navbar')
                            .toggleClass('mbr-navbar--open'); //.removeClass('mbr-navbar--short')
        ...
        $(window).scroll(function(){
            ...
            var scrollUp  = scrollTop <= prevScrollTop || true;
...
!function() {
    var ele = document.getElementsByClassName('engine')[0];
    if (ele != undefined) {
        ele.getElementsByTagName('a')[0].removeAttribute('rel');
    }	
